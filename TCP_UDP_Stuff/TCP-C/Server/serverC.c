...
////        int len = recv(c, (char*)(&nr), sizeof(nr), 0);
////        nr = ntohs(nr);
////        printf("\n\t%d", nr);
////        char str[256];
////        for(int i=0;i<=nr;i++) {
////            recv(c, &str[nr-i], sizeof(str[nr-i]), 0);
////        }
////
////        for(int i=0; i<=nr; i++){
...
//
//
//        /// RECEIVE AN INT AND RETURN THE LIST OF ITS DIVISORS (LAB1, PB5)
////        int number;
////        recv(c, (char*)(&number), sizeof(number), 0);
////        number = ntohs(number);
////        int idx = 0;
////        int divisors[256];
...
////            }
////        }
////        int divlen = htons(idx);
////        send(c, (char*)&divlen, sizeof(divlen), 0);
////        for(int i = 0; i < idx; i++)
////            send(c, (char*)(&divisors[i]), sizeof(divisors[i]), 0);
//
//
//
//
